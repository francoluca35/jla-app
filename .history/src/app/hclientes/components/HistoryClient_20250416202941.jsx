...
export default function HistoryClient() {
  ...
  const [ocultarSena, setOcultarSena] = useState(false); // 👈 control visual
          ...
          <React.Fragment key={index}>
            ...
            <div
              ...
              onClick={() => {
                ...
                setOcultarSena(false); // 👈 reinicia el estado de seña oculta
              }}
            >
              +
            </div>
        ...
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-lg animate-fade-in">
            ...
            <div className="space-y-4 text-left text-gray-800">
              ...
              {/* Servicios con botón para cancelar seña */}
              <div>
                ...
                <ul className="list-disc pl-6 mt-1 text-gray-700">
                  {selectedClient.sertec?.map((s, i) => {
                    if (s.tipo === "seña" && ocultarSena) return null;
