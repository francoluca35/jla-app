    ...
    >
      ...
      {selectedClient && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4">
          <div className="bg-white w-full max-w-lg rounded-xl shadow-xl overflow-y-auto max-h-[90vh] p-4 sm:p-6">
            <h2 className="text-2xl sm:text-3xl font-bold text-green-800 mb-4 sm:mb-6 text-center break-words">
              Detalles del Cliente
            </h2>

            <div className="space-y-4 text-left text-gray-800 break-words">
              {isEditing ? (
                <>
                  {[
