    ...
    >
      ...
      {selectedClient && (
        <div className="fixed inset-0 z-50 bg-black/50 backdrop-blur-sm flex items-center justify-center px-2 sm:px-4">
          <div className="bg-white w-full max-w-3xl rounded-xl shadow-2xl overflow-y-auto max-h-[90vh] p-4 sm:p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-gray-800">
              ...
              <div className="space-y-2">
                ...
                <p>
                  <strong>Forma de pago:</strong> {selectedClient.paymentOption}
                </p>
                <p>
            ...
            <div className="mt-6 flex flex-col sm:flex-row gap-3">
              <button
                ...
                className="w-full bg-gray-300 hover:bg-gray-400 text-black font-semibold py-2 rounded-lg"
              >
                Cerrar
              </button>
