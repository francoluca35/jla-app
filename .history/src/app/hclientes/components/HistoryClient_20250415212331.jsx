...
export default function HistoryClient() {
  ...
  return (
    ...
    >
      ...
      <div className="w-full  bg-verdefluort max-w-4xl grid grid-cols-5 text-center font-bold">
        <div className="p-2 bg-[#1f2c26] text-black font-bold">Nombre</div>
        <div className="p-2 bg-[#1f2c26] text-black font-bold">Sucursal</div>
        <div className="p-2 bg-[#1f2c26] text-black font-bold">Fecha</div>
        <div className="p-2 bg-[#1f2c26] text-black font-bold">Tipo</div>
        <div className="p-2 bg-[#1f2c26] text-white font-bold">+</div>
        ...
        {filteredClientes.map((cliente, index) => (
          <React.Fragment key={index}>
            ...
            <div className="p-2 bg-[#1f2c26] text-black">{cliente.branch}</div>
            <div className="p-2 bg-[#84b89b] text-black">
              {new Date(cliente.date).toLocaleDateString()}
            </div>
            <div className="p-2 bg-[#1f2c26] text-black">
              {cliente.problemType}
            </div>
            <div
