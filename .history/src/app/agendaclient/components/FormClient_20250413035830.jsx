...
const FormClient = () => {
  ...
  return (
    <form
      ...
      className="bg-[#1f1f22] text-white p-4 flex flex-col gap-4 w-full max-w-md mx-auto"
    >
      ...
      {problemType === "presupuesto" && (
        <div className="bg-gray-300 text-black p-2 rounded-md flex gap-2 justify-between">
      ...
      {problemType === "presupuesto" && paymentOption && (
        <input
          type="number"
          placeholder="$ Monto"
          value={amount}
      ...
      {problemType === "arreglo" && (
        <div className="bg-gray-300 text-black p-2 rounded-md flex gap-2 justify-center">
          <label className="flex items-center gap-2">
      ...
      <textarea
        ...
        className="rounded-lg px-4 py-2 bg-gray-300 text-black"
      />

      <button
        type="submit"
        className="bg-green-500 rounded-full py-2 font-bold text-black"
      >
        GUARDAR
      </button>
    </form>
