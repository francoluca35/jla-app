...
const FormClient = () => {
  ...
  return (
    <form
      ...
      className="bg-tabla text-white p-4 flex flex-col gap-4 w-full max-w-md mx-auto rounded-md"
    >
      <BackArrow />
      ...
      <button
        type="submit"
        disabled={loading}
        className="bg-verdefluor text-black font-bold rounded-full py-2"
      >
