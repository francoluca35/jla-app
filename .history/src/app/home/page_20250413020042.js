        ...
        <div className="grid grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-1 lg:w-1/4">
          {botones.map((btn, i) => (
            <button
              ...
              className="bg-verdefluor text-black rounded-xl w-full h-32 lg:h-20 flex flex-col items-center justify-center shadow-md hover:bg-green-600 transition text-white"
            >
              {btn.icono}
