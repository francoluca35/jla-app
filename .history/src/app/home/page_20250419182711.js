...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Cuerpo */}
      <div className="flex flex-col lg:flex-row items-center justify-center gap-12 w-full px-4 pb-10">
        {/* Tabla */}
        <div className="bg-white/20 rounded-lg p-6 backdrop-blur-md shadow-lg text-sm w-[320px]">
