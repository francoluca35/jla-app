...
const IngresarGastos = () => {
  ...
  const [tipoDePago, setTipoDePago] = useState(""); // "efectivo" o "transferencia"
  ...
  return (
    ...
    >
      <div className="max-w-md mx-auto bg-black bg-opacity-70 p-6 rounded-xl">
        ...
        {/* Botones tipo toggle para tipo de gasto */}
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <div className="flex gap-2">
            <button
              type="button"
              onClick={() => setTipoDePago("efectivo")}
              className={clsx(
            ...
            <button
              type="button"
              onClick={() => setTipoDePago("transferencia")}
              className={clsx(
                "flex-1 p-2 rounded font-semibold",
