export async function POST(req) {
  try {
    ...
    // Aquí usamos el challenge almacenado para verificar la autenticación
    ...
    console.log("Challenge recibido del backend:", challenge); // Verifica si el challenge se recibe correctamente
