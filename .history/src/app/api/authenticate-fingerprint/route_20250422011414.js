...
export async function POST(req) {
  try {
    ...
    // Aquí generamos el challenge solamente para huella digital
    ...
    // Asegúrate de reemplazar 'https://tudominio.com' por tu dominio de producción
    const origin = "https://jlatecnicos.online"; // Reemplazar con tu dominio de producción

    return new Response(
      JSON.stringify({
        challenge,
        origin, // Asegúrate de que el origen sea el correcto
      }),
